...
int main()
{
    ...
    // Major Property of a GPU is the first digit of a number // 6
    printf("major: %d\n", properties.major);
    // Minor Property of a GPU is the second digit of a number // 1
    printf("minor: %d\n", properties.minor);
    // major.minor is the computing capability: in this case is 6.1
